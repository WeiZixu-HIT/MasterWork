...
if(NOT "/home/icebear/MyProjects/ROSProjects/yoloqt_ws/devel/include " STREQUAL " ")
  set(yolov8qt_INCLUDE_DIRS "")
  set(_include_dirs "/home/icebear/MyProjects/ROSProjects/yoloqt_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yolov8qt' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/icebear/MyProjects/ROSProjects/yoloqt_ws/src/yolov8qt/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/icebear/MyProjects/ROSProjects/yoloqt_ws/devel/lib;/opt/ros/noetic/lib)
